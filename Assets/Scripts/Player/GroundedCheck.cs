...
public class SurfaceCollisionEvents
{
    ...
    public UnityEvent<Collider2D> onEnterCollision = new UnityEvent<Collider2D>();
        
    [Tooltip("Passes the collider which was exited.")]
    public UnityEvent<Collider2D> onExitCollision = new UnityEvent<Collider2D>();
}
...
public abstract class GroundedCheck : MonoBehaviour
{
    ...
    public abstract Collider2D ConnectedCollider { get; }
